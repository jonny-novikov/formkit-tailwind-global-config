...
const boxClassification = {
  ...
  help: 'mb-2',
  input:
    'form-check-input appearance-none h-5 w-5 mr-2 border border-gray-500 bg-white checked:bg-blue-500 focus:outline-none focus:ring-0 transition duration-200',
